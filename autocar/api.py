...
hear_face = '/user/local/share/opencv4/hearcascades/hearcascade_frontalface_default.xml'
face_cascade = cv2.CascadeClassifier(hear_face)
cap = cv2.VideoCapture(cam, cv2.CAP_GSTREAMER)
if not cap.isOpened():
...
try:
    for _ in range(12000):
        ...
        faces = face_cascade.detectMultiScale(gray, scaleFactor=1.3, minNeightbors=1, minSize=(100, 100))
